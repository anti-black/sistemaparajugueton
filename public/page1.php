		...
		<nav class='light-blue accent-3'>
			...
			<a id='logo-container' href='../principal/index.php' class='brand-logo'><img class='todo-shrink-navlogo' src='../img/logo.png'/></a>
				...
				<ul class='right hide-on-med-and-down'>
					...
					<li><a href='../eventos/eventos.php'><i class='material-icons left'<i class='material-icons left'>today</i>Eventos</a></li>
					<li><a href='../noticias/noticias.php'><i class='material-icons left'<i class='material-icons left'>content_paste</i>Noticias</a></li>". (($sesion) ? "
					<li><a href='../productos/carrito.php'><i class='material-icons left'<i class='material-icons left'>shopping_cart</i></a></li>" : '')."
					<li><a class='dropdown-button' href='#' data-activates='dropdown'><i class='material-icons left'>perm_identity</i><span id='nombS'>$nombre</span></a></li>
				</ul>
				...
				<ul class='side-nav' id='mobile'>
					...
					<li><a href='../noticias/noticias.php'><i class='material-icons left'<i class='material-icons left'>content_paste</i>Noticias</a></li>
					<li><a href='../productos/carrito.php'><i class='material-icons left'<i class='material-icons left'>today</i>Eventos</a></li>
				</ul>
	...
	<footer class='page-footer blue-grey lighten-5'>
			...
			<div class='row'>
				<div class='col s12 m6 l4'>
					...
					<ul>
						...
						<li><a class='grey-text' href='#!'>Facebook</a></li><i class='fa-li fa fa-check-square'></i>
		...
		<div class='footer-copyright teal'>
			<div class='container'>
				...
				<center><span class='white-text text-darken-2'>2016 Jugueton El Salvador ©</span></center>
			</div>
		</div>
	</footer>
