...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("jugueton1sv@gmail.com"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP, podemos usar el de Google, Outlook, etc...
    ...
    $mail->SMTPAuth = true;
    $mail->Username = "jugueton1sv@gmail.com";  // Correo Electrónico
    $mail->Password = "expojugueton2016"; // Contraseña del correo
