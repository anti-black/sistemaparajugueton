...
class configuraciones {
   private static function IgnorarSeguridadGeneral() { return true; }
	public static function IgnorarSeguridadDeSesiones() { return true || self::IgnorarSeguridadGeneral(); }
	public static function IgnorarSeguridadDeAutoCerrado() { return true || self::IgnorarSeguridadGeneral(); }
}
...
class conexion extends configuraciones {
...
class seguridad extends conexion
{
	public static function haySesionIniciada(){
		if (configuraciones::IgnorarSeguridadDeSesiones()) return configuraciones::IgnorarSeguridadDeSesiones();
...
class pagina extends seguridad {
 ...
 <body id='ZERRATO'>".(($archivoPadre != 'login.php') ? "
				...
				<ul id='slide-out' class='side-nav fixed leftside-navigation ps-container ps-active-y' style='width: 240px;'>
					...
					<li class='no-padding'>
						<ul class='collapsible collapsible-accordion'>
							...
							<li><a href='/phpmyadmin/'><i class='material-icons left'>data_usage</i>phpMyAdmin</a></li>
	...
	<script src='../js/alteraciones.js'></script>";
		$footer .= ($archivoPadre != 'login.php') && (!configuraciones::IgnorarSeguridadDeAutoCerrado()) ? "
