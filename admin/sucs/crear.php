...
if (!empty($_POST)) {
	if (isset($_POST['suc']) && isset($_POST['det'])) {
		...
		$sql = "INSERT INTO sucursales(sucursal, direccion_sucursal, datosmapas) VALUES(?,?,?);";
		if (!(strlen($errores) > 0)){
			if (pagina::ejecutar($sql, array($suc, $det, $maps)))
				header('Location: ./');
		}
	} else
	...
	<div class="row">
		<div class="col s12 m8 l6">
			<div class="card-panel">
				<h4 class="header2">Crear una nueva sucursales</h4>
