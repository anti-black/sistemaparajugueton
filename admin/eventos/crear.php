...
$cabecera =  echo Pagina::header("Crear evento");
...
if(!empty($_POST)) {
	$data = pagina::obtenerFilas('SELECT * FROM eventos WHERE nombre_evento LIKE ?;', array($var));
	if (preg_match("/^[a-zA-Z0-9 \x7f-\xff]{1,25}$/", $var)) {
		if (!empty($var3) || !empty($var4)) {
			...
			elseif (empty($data)) {
				...
				$sql = "INSERT INTO eventos(nombre_evento, detalle_evento, lugar, fecha_inicio, fecha_fin) VALUES(?,?,?,?,?);";
				$params = array($var, $var1, $var2, $var3, $var4);
		...
		<div class='row'>
			...
			<div class="col s12 m6 l4">
				<div class="input-field col s12">
					<textarea id="detalle_evento" name="detalle_evento" placeholder="Información extra del evento" class="materialize-textarea" length="250" required><?php echo $var1; ?></textarea>
			...
			<div class="col s12 m6 l4">
				<div class="input-field col s12">
					...
					<input id="fecha_inicio" type="date" class="datepicker" name="fecha_inicio" value="<?php echo $_POST['fecha_inicio']; ?>">
				</div>
			</div>
			<div class="col s12 m6 l4">
				<div class="input-field col s12">
					<label for="fecha_fin">Fecha de fin</label>
					<input id="fecha_fin" type="date" class="datepicker" name="fecha_fin" value="<?php echo $_POST['fecha_fin']; ?>">
				</div>
			</div>
		</div>
		<br/>
