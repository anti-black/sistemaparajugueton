...
{//encabezado de la pagina
  Pagina::header("Agregar producto");
...
<form method='post' class='row' enctype='multipart/form-data' autocomplete="off" action="crear.php">
 ...
 <div class='input-field col s12 m6'>
						<?php pagina::armarCombo('categoria', $categoria, "SELECT * FROM categorias WHERE estado = 1;") ?>
					</div>
					</div>
					<div class='input-field col s12 m6'>
						<?php pagina::armarCombo('clasificacion', $categoria, "SELECT * FROM clasificaciones WHERE estado = 1;") ?>
					</div>
					<div class='input-field col s12 m6'>
						<?php pagina::armarCombo('marca', $categoria, "SELECT * FROM marcas WHERE estado = 1;") ?>
					</div>
</div>
<div class='row'>
